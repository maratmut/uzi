...
export default function Home() {
  return (
    <>
      <Script id="schema-medical-organization" type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "MedicalBusiness",
          "name": "ООО Центр современной медицины - УЗИ для беременных в Махачкале",
          "url": "https://uzi05.ru",
          "logo": "https://uzi05.ru/child.webp",
      ...
      <Script id="schema-person-1" type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Physician",
      ...
      <Script id="schema-person-2" type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Physician",
      ...
      <main className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="bg-gradient-to-b from-rose-50 to-white py-8 sm:py-12 lg:py-16">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
            <div className="grid items-center gap-8 md:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-12">
              <BabyScene />
              <div className="flex min-w-0 flex-col items-start">
                <h1 className="mb-6 text-[clamp(1.75rem,3.5vw,3rem)] font-bold leading-[1.1] text-gray-900">
                  УЗИ беременности и гинекологическое УЗИ в Махачкале
                </h1>
                ...
                <div className="grid w-full grid-cols-[repeat(auto-fit,minmax(min(100%,12rem),1fr))] gap-6">
                  <div className="flex min-w-0 flex-col gap-3">
                    <p className="flex-1 text-sm font-semibold text-gray-700">Алиева Шехеризада Расуловна</p>
                    <a
                      href="tel:+79882681666"
                      className="flex min-h-11 items-center justify-center whitespace-nowrap bg-rose-400 hover:bg-rose-500 text-white px-3 py-2 rounded-full text-base transition-colors shadow-md text-center"
                    >
                      +7 (988) 268-16-66
                    </a>
                    <a
                      ...
                      className="min-h-11 bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded-full text-base transition-colors shadow-md text-center flex items-center justify-center"
                    >
                  ...
                  <div className="flex min-w-0 flex-col gap-3">
                    <p className="flex-1 text-sm font-semibold text-gray-700">Салихова Тамара Руслановна</p>
                    <a
        ...
        <section className="py-8 bg-white">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
            ...
            <div className="grid gap-6 max-w-5xl mx-auto lg:grid-cols-3 lg:gap-8">
        ...
        {/* Contact Section */}
        <section id="contacts" className="scroll-mt-24 py-8 bg-white">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8">
                {/* Первый специалист */}
                <div className="min-w-0 bg-rose-50 p-5 sm:p-8 rounded-2xl">
