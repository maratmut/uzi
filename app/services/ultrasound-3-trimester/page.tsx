...
export const metadata: Metadata = {
  title: 'УЗИ скрининг 3 триместра в Махачкале | УЗИ перед родами',
  description: 'Профессиональное УЗИ 3 триместра в Махачкале. Оценка положения плода, плаценты, готовности к родам. Врачи Тамара Салихова и Шехеризада Расуловна.',
  keywords: 'узи беременности в Махачкале, узи для беременных в махачкале, скрининг 3 триместра, узи Тамара Салихова, узи Шехеризада Расуловна',
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-rose prose-lg">
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-600 mb-8">
              ...
              <li><strong>Предполагаемый вес:</strong> исключаем задержку развития или, наоборот, крупный плод.</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              <strong> Шехеризада Расуловна</strong> и <strong>Тамара Салихова</strong> — это гарантия внимательного отношения и точного диагноза. Их многолетний опыт позволяет замечать нюансы, которые могут ускользнуть от менее опытного взгляда.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              В рамках третьего скрининга мы обязательно проводим допплерометрию — оценку кровотока в сосудах матки, пуповины и мозга плода. Это позволяет исключить гипоксию (кислородное голодание) и убедиться, что малыш чувствует себя хорошо.
            </p>
