...
export const metadata = createPageMetadata(
  'Допплерометрия при беременности в Махачкале — УЗИ кровотока',
  'Допплерометрия при беременности в Махачкале: оценка кровотока в сосудах матки, плаценты и плода по назначению врача. Запись по телефону и WhatsApp.',
  '/services/dopplerometry/',
)
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-rose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              Исследование проводится с помощью ультразвукового датчика. Аппарат регистрирует параметры движения крови в сосудах и отображает данные, которые оценивает специалист. Метод не использует ионизирующее излучение и проводится по медицинским показаниям.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              Исследование выполняется на аппарате Voluson Expert 22. Результаты оценивают врачи ультразвуковой диагностики Тамара Салихова и Шехеризада Расуловна.
            </p>
            
            <p className="text-gray-600 mb-6">
              Заключение допплерометрии передается лечащему врачу, который интерпретирует результаты с учетом срока беременности и других клинических данных.
            </p>
