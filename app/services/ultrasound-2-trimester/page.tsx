          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-6xl mx-auto">
            <div className="w-full md:w-1/2">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Скрининг II триместра беременности в Махачкале
              </h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Второй скрининг — это, пожалуй, самое детальное знакомство с анатомией вашего будущего ребенка. 
                Именно на этом этапе мы можем подтвердить, что малыш развивается правильно, и с высокой точностью определить его пол.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-rose prose-lg">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              Что мы смотрим на втором скрининге?
            </h2>
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-600 mb-8">
              ...
              <li><strong>Плацента и пуповина:</strong> оцениваем место прикрепления, кровоток.</li>
            </ul>
            ...
            <ul className="space-y-4 mb-8">
              <li className="bg-rose-50 p-4 rounded-xl">
                <strong className="block text-gray-900 text-lg mb-1">Опытнейшие врачи</strong>
                <span className="text-gray-600">Вас примут ведущие специалисты республики. <strong>Тамара Салихова</strong> (кандидат медицинских наук) и <strong>Шехеризада Расуловна</strong> (врач высшей категории) — это имена, которым доверяют тысячи мам.</span>
              </li>
              <li className="bg-rose-50 p-4 rounded-xl">
            ...
            <p className="text-gray-600 mb-6">
              Второй триместр — это &quot;золотая середина&quot; беременности. Большинство пороков развития, если они есть, выявляются именно сейчас. Своевременное качественное <strong>узи беременности в Махачкале</strong> дает родителям уверенность и спокойствие, либо позволяет вовремя принять необходимые меры.
            </p>

            <div className="bg-rose-50 p-6 md:p-8 rounded-2xl mt-12 text-center">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                Узнайте пол вашего малыша
              </h3>
              <p className="text-gray-600 mb-6">
                Запишитесь на второй скрининг к лучшим специалистам города. Мы сделаем вашу встречу с малышом незабываемой.
              </p>
