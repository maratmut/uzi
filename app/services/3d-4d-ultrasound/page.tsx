...
export const metadata: Metadata = {
  title: '3D/4D УЗИ беременности в Махачкале | Фото и видео плода',
  description: 'Сделать 3D/4D УЗИ при беременности в Махачкале. Получите первую фотографию и видео вашего малыша. Высокоточное оборудование Voluson Expert 22. Врачи Тамара Салихова и Шехеризада Расуловна.',
  keywords: 'узи беременности в Махачкале, 3д узи махачкала, 4д узи махачкала, узи Тамара Салихова, узи Шехеризада Расуловна',
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-rose prose-lg">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Благодаря высочайшему разрешению, наши специалисты могут не только показать родителям красивые кадры, но и провести глубокую диагностику развития плода, исключив патологии, которые могут быть невидны на обычном оборудовании.
            </p>
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="bg-blue-50 p-4 rounded-xl">
                ...
                <span className="text-gray-600">Врач высшей категории. <strong>Шехеризада Расуловна</strong> — это гарантия внимательного отношения и экспертного заключения. Огромный опыт работы позволяет ей видеть малейшие нюансы развития.</span>
              </li>
            </ul>
